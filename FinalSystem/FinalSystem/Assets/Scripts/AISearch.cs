...
public class AISearch {
	...
	{
		agent = GameObject.FindGameObjectWithTag ("Agent0");
	...
	void doSearchMethods()
	{
		...
		if (AISearch.canWalk == true) {
			...
			for(int count = 0; count < finalSolution.Length; count++)
				Debug.Log(Time.realtimeSinceStartup + "  id = " + finalSolution[count].getID());
